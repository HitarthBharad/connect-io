...
const processText = async (text: string, thoughtId: string, userId: string) => {
    ...
    const reducedEmbedding = reduceEmbeddingDimension(embedding, initialEmbeddings);
